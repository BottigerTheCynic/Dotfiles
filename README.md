...
# Note
My Sway Config does have some Gentoo related code and it is safe to remove and replace those lines. The Config may have some module for a laptop especially in the waybar config and dunst config however, you can remove those lines and configure it the way you like it!
